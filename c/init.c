...
void initproc( void )				/* The beginning */
{
 ...
 // kprintf("Creating Idle Process\n");
  ...
  create( root_testing_sysopen, PROC_STACK );
  create( root_testing_sysclose, PROC_STACK );
  create( root_testing_syswrite, PROC_STACK );
  create( root_testing_signal, PROC_STACK );
  */
